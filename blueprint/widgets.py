""" 
main/widgets.py: file containing the widgets of our app
"""
...
class LabelInput(customtkinter.CTkFrame):
  ...
  def __init__(
    ...
    #   self.input = tk.Frame(self)
      self.input = customtkinter.CTkFrame(self)
    ...
    self.input.grid(row=1, column=0, sticky=(tk.W + tk.E))                          # Label on Top of widget
    self.columnconfigure(0, weight=1)

    # self.input.grid(row=0, column=1, sticky=(tk.W + tk.E ), padx=(10,0))          # Label on Left side of widget
